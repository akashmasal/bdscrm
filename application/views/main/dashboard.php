                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-centered m-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th>
                                                    <img src="<?php echo base_url();?>assets/images/users/avatar-1.jpg" alt="user" class="avatar-sm rounded-circle" />
                                                </th>
                                                <td>
                                            ...
                                            <tr>
                                                <th>
                                                    <img src="<?php echo base_url();?>assets/images/users/avatar-2.jpg" alt="user" class="avatar-sm rounded-circle" />
                                                </th>
                                                <td>
                                            ...
                                            <tr>
                                                <th>
                                                    <img src="<?php echo base_url();?>assets/images/users/avatar-3.jpg" alt="user" class="avatar-sm rounded-circle" />
                                                </th>
                                                <td>
                                            ...
                                            <tr>
                                                <th>
                                                    <img src="<?php echo base_url();?>assets/images/users/avatar-4.jpg" alt="user" class="avatar-sm rounded-circle" />
                                                </th>
                                                <td>
                                            ...
                                            <tr>
                                                <th>
                                                    <img src="<?php echo base_url();?>assets/images/users/avatar-5.jpg" alt="user" class="avatar-sm rounded-circle" />
                                                </th>
                                                <td>
